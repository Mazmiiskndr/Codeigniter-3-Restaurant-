<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?= base_url('admin/gallery') ?>" class="d-none d-sm-inline-block btn  btn-danger shadow-sm" ><i class="fas fa-backward fa-sm text-white-50"></i> Kembali</a>
          </div>
          	...
          	<div class="col-md-6">
          		...
          		<div class="card">
                        <div class="card-body">
                            ...
                            <form class="mt-3" action="<?= base_url('admin/gallery/update_gallery_aksi') ?>" method="post" enctype="multipart/form-data">
          ...
          <img src="<?= base_url(). 'assets/uploads/gallery/'.$row->gambar ?>" class="figure-img img-fluid rounded" width="750px">
